...
SECRET_KEY = 'django-insecure-g4b1xd4#ihv+31z%em43qm5djl%h)))c9u-2wtv$@$22=)^dbr'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Store static files in 'static' folder

MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR / 'media'  # Store uploaded files in 'media' folder
